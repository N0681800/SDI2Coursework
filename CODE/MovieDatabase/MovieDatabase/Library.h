...
{4,"Insuffcient Info"},{ 5,"No Materials avalible" } };
...
const vector<ColumnStructure> ACTOR_TABLE = { 
	{"ID",ID_LENGTH },{"Name",MAX_NAME_LENGTH},{"Gender",10},{"Films",MAX_FILM_LENGTH} };
...
const vector<ColumnStructure> FILM_TABLE = { 
	{"ID", ID_LENGTH }, { "Title",MAX_TITLE_LENGTH }, { "Genre",MAX_GENRE_LENGTH }, { "Date",10 }, { "Runtime",10 },
